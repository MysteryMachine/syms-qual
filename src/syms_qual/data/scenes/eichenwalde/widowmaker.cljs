...
(def data
  {[:spawn :widowmaker 0]
   ...
   [:widow :text]
   [:miranda/narration
    "You decided to get yourself an ice tea before setting up on the roof, but as you were waiting for your order to filled, several members of the staff came forward, grabbed Amelie, and dragged her into the kitchen. Apparently, when Reaper and friends were arrested for blowing up the coffee shop last Halloween, he named Amelie LaCroix as the person who could be held responsible for the damages. They recognized her from her blue tint, and demanded that she work off the debt by doing dishes since she wasn't carrying any cash."
    "You felt too awkward to abandon your teammate, but one glance at the brackish water in the sink they had assigned her to reaffirmed your conviction that you would not be helping her with her dilemma in any way. After an hour or so of cleaning they let you go, but by that point, the match was already over and your team had lost quite badly. Widowmaker looked angry at you, but you could quite easily ascertain she was too embarrassed to say anything about the events that transpired."
