...
(def data
  {[:calveras :sombra 0]
   ...
   [:miranda/dialogue
    ...
    ["Genji" [[:sombra :_drinkNeutral (scoot 18)]  [:doomfist :_drinkHold (scoot -8)] [:genji :_explain (scoot -14)] [:symmetra :_awkward (scoot 10)]] "I never kid, Sombra. Now, if you'll excuse me, Angela has called for me. She says my gluteal cyber implants need oiling."]
 ...
 [:calveras :sombra 2]
  [:miranda/dialogue
    ["Doomfist" [[:sombra :_drinkNeutral (scoot 12)]  [:doomfist :_drinkPointUp (scoot -20)] [:symmetra :_neutral (scoot 5)]] "We have mysteries that need solving. And most importantly, to figure out if you can get us to Isla de las Munecas this weekend after the match."]
    ...
    ["Sombra" [[:symmetra :_neutral (scoot 5)] [:sombra :_drinkShrug (scoot 12)] [:doomfist :_drinkHold (scoot -20)]] "So the ghost isn’t very good at spelling out spanish words. All I know is that there’s probably some little kid looking for his amigo in our house."]
