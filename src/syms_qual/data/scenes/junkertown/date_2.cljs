...
(def data
  {[:field 0]
   ...
   [:miranda/dialogue
    ...
    ["Symmetra" [[:clouds :_field (move [0 25])] [:clouds :_snore (scoot -15 -20 2)]] "How rude."]
    ["Junkrat" [[:clouds :_field (move [0 25])] [:clouds :_snore (scoot -20 -25 2)]] "I’ve heard if you get real quiet though, you can hear their snoring in the wind."]
    ["Symmetra" [[:clouds :_field (move [0 25])] [:clouds :_snore (scoot -25 -30 2)]] "It might not be them then, I don’t think I can hear it."]
    ["Junkrat" [[:clouds :_field (move [0 25])] [:clouds :_snore (scoot -30 -35 2)]] "You gotta close your eyes and listen."]
    ["Symmetra" [[:clouds :_field (move [0 25])] [:clouds :_snore (scoot -35 -40 2)]] "Ah, there it is."]
    ["Junkrat" [[:clouds :_field (move [0 25])] [:clouds :_snore (scoot -40 -45 2)]] "…"]
    ["Symmetra" [[:clouds :_field (move [0 25])] [:clouds :_snore (scoot -45 -80 3)]] "Jamie?"]
    :-> [:junkrat-b]]
