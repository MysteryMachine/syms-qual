  ...
  {[:party :moira 0]
   [:miranda/dialogue
    ...
    ["Zarya" [[:zarya :_pointUp (scoot -15)] [:mei :_thumbsUp (scoot -20)] [:soldier76 :_grillDrinkNeutral (scoot 18)] [:reaper :_reverseNeutral (scoot 15)] [:lucio :_jammin (scoot 25)] [:symmetra :_confused (scoot 9)]]
     "Thank you for this valuable information, puny one. I would invite you to join us but I do not think you will be able to keep up with such small legs. Ice wife, let's go! Full sprint pace. We must limit our exposure to cardio so we not lose gains."]
