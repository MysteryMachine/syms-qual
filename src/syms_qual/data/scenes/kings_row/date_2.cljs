  ...
  {[:street :junkrat 4]
   ...
   [:miranda/dialogue
    ["Symmetra" [[:photos :_fancyDressJunk] [:phones :_junkratHand]]
     "Junkrat, this is clearly an outfit for a costume party or something."]
   ...
   [:miranda/dialogue
    ...
    ["Junkrat" [[:junkrat :_shyblush (scoot -13)] [:symmetra :_smile (scoot 3)]]
    ...
    ["Symmetra" [[:junkrat :_ballSmile (scoot -13 10 1.5)] [:symmetra :_explainUncomfortable (scoot 3 80 1.5)]]
     "Yes, let’s go."]
    ["Junkrat" [[:junkrat :_ballNeutralExtraFire (scoot 10)]]
