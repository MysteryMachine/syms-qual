...
(def data
  {[:spawn :mercy 0]
   [:miranda/dialogue
    ...
    ["Mercy" [[:mercy :_pointUp (scoot -15)]  [:symmetra :_awkward (scoot 0 3 2)]] "Ever since he had that Thanksgiving Dinner in a Can, he stopped growing some of of his facial hair, but has since had back hair that uncannily resembles a turkey dinner inside a pentagram."]
