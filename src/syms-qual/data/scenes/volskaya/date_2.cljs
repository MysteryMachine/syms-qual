...
(def data
  {[:apartment :sombra 7]
   [:miranda/dialogue
    ["Sombra" [[:sombra :_awkward (scoot -3)] [:symmetra :_neutral (scoot 0)]]
     "Hey. Um. Sorry you got stuck with me all day."]
    ["Symmetra" [[:sombra :_neutral (scoot -3)] [:symmetra :_no (scoot 0)]]
     "It was fine. But, your show is not my thing"]
    ...
    ["Symmetra" [[:sombra :_neutral (scoot -3)] [:symmetra :_frown (scoot 0)]]
    ...
    ["Symmetra" [[:sombra :_frown (scoot -3)] [:symmetra :_sad (scoot 0)]]
   ...
   [:miranda/dialogue
    ...
    ["Sombra" [[:sombra :_flirty (scoot -3)] [:symmetra :_neutral (scoot 0)]]
     "Worth the loss?"]
    ["Symmetra" [[:sombra :_dismayed (scoot -3)] [:symmetra :_no (scoot 0)]]
     "No."]
