  ...
  {[:street :junkrat 3]
   [:miranda/dialogue
    ...
    ["Roadhog" [[:junkrat :_ballNeutral (scoot 5)] [:roadhog :_thumbPoint (scoot -25)] [:symmetra :_toastHand (scoot 8)]]
     "Let’s go."]
    ["Junkrat" [[:junkrat :_teethPoint (scoot 5)] [:roadhog :_drink (scoot -25)] [:symmetra :_toast (scoot 8)]]
    ...
    ["Symmetra" [[:junkrat :_ballNeutral (scoot 5)] [:roadhog :_neutral (scoot -25)] [:symmetra :_toastChew (scoot 8)]]
    ...
    ["Roadhog" [[:junkrat :_ballNeutral (scoot 5)] [:roadhog :_neutral2 (scoot -25)] [:symmetra :_toastBite (scoot 8)]]
     "They ARE pop rocks."]
    ["Junkrat" [[:junkrat :_shhh (scoot 5)] [:roadhog :_neutral2 (scoot -25)] [:symmetra :_toastBite (scoot 8)]]
     "Oy, Roadie, shhh! Don’t betray my secret spice! You know I can't afford real sichuan peppercorns."]
    ["Roadhog" [[:junkrat :_sigh (scoot 5)] [:roadhog :_neutral (scoot -25)] [:symmetra :_toastBite (scoot 8)]]
     "My bad."]
