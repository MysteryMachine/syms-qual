  ...
  {[:street :junkrat 0]
   [:miranda/dialogue
    ["Junkrat" [[:junkrat :_ballWave (scoot -70 5 1)] [:roadhog :_neutral (scoot -90 -25 1)] [:symmetra :_neutral (scoot 73 8 1)]]
     "Owyagarn, awright?"]
    ["Symmetra" [[:junkrat :_ballNeutral (scoot 5)] [:roadhog :_neutral (scoot -25)] [:symmetra :_awkward (scoot 8)]]
     "Pardon?"]
   ...
   [:miranda/dialogue
    ["Junkrat" [[:junkrat :_ballBackThumb (scoot 5)] [:roadhog :_neutral (scoot -25)] [:symmetra :_neutral (scoot 8)]]
     "Ol’ pig face here was telling me about your wild robot rodeo, yesterday. Smart thinking to use the bot to your advantage. Shame it turned on you in the end, but I like your go big or go home style. Think we could borrow your tactical genius for a sec?"]
    :-> [:street :junkrat 1]]
   ...
   [:miranda/dialogue
    ...
    ["Junkrat" [[:junkrat :_ballBack (scoot 5)] [:roadhog :_neutral (scoot -25)] [:symmetra :_WTF (scoot 8)]]
     "Roadie! You sweetheart. She’s not being a bully, she’s just not gotten a chance to know us. Now look, Satya…"]
    ["Symmetra" [[:junkrat :_ballNeutral (scoot 5)] [:roadhog :_neutral (scoot -25)] [:symmetra :_explainWTF (scoot 8)]]
     "Symmetra."]
    ...
    ["Junkrat" [[:junkrat :_chart (scoot 5)] [:roadhog :_neutral (scoot -25)] [:symmetra :_sass (scoot 8)]]
     "The way it works is that we’ve added a radio transmitter to my trap, and when it springs, the device detects the radio signal and fires a hook straight at our trapped target, pulling it into our vile clutches!"]
   ...
   [:miranda/dialogue
    ...
    ["Junkrat" [[:junkrat :_fibbin (scoot 5)] [:roadhog :_neutral (scoot -25)] [:symmetra :_WTF (scoot 8)]]
    ...
    ["Junkrat" [[:junkrat :_ballWink (scoot 5)] [:roadhog :_neutral (scoot -25)] [:symmetra :_confused (scoot 8)]]
