...
(def data
  {[:street :intro]
   ...
   [:miranda/text-option
    "What will you do?"
    ["Talk to Torbjorn" (constantly true) [:street :torb 0]]
    ["Talk to Junkrat and Roadhog" (constantly true) [:street :junkrat 0]]
    ["Talk to Bastion and Lucio" (constantly true) [:street :lucio 0]]]})
