...
(def data
  {[:spawn :efi 0]
   [:miranda/dialogue
    ...
    ["Orisa" [[:orisa :_handShoulder] [:lucio :_neutral (scoot -5)]
              [:efi :_neutral (scoot 15)]]
    ...
    ["Lucio" [[:orisa :_neutral] [:lucio :_explainForward (scoot -5)]
    ...
    ["Lucio" [[:orisa :_neutral] [:lucio :_jammin (scoot -5)]
              [:efi :_neutral (scoot 15)] [:symmetra :_neutral (scoot 7)]]
    ...
    ["Efi" [[:orisa :_neutral] [:lucio :_jammin (scoot -5)]
            [:efi :_smug (scoot 15)] [:symmetra :_neutral (scoot 7)]]
     "Oh, Lucio…"]
    ["Efi" [[:orisa :_neutral] [:lucio :_neutral (scoot -5)]
            [:symmetra :_neutral (scoot 7)] [:efi :_explain (scoot 15)]]
