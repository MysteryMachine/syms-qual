  ...
  {[:door :pharah 0]
   ...
   [:door :pharah 2]
    ...
    [:miranda/dialogue
     ...
     ["McCree" [[:pharah :_reverseNeutral (scoot 8)] [:mccree :_point (scoot -20)] [:symmetra :_smile (scoot 10)]] "Yep! I reckon as a teen, I stashed them with the magazines right after the heist. I stopped shootin’ assault rifles soon after my time in Gibralter, so they got left behind in the secret stash, with the rest of the Blackwatch smut."]
