...
(def data
  {[:spawn :mercy 0]
   ...
   [:miranda/dialogue
    ["Mercy" [] "Gonna go party harder, huh? Well, don’t let me stop you. I have to drive home tonight, so I don’t even think I’ll finish this EVST."]
    ["Mercy" [] "That’s short for an extra virgin Shirley Temple."]
    ["Mercy" [] "I should really start watching those movies."]
    ["Mercy" [] "Shirley Temple is sort of an aesthetic I really think I can pull off, you know?"]
    ["Mercy" [] "Youth is sort of important to me, it’s why I lab ratted myself with youth serum."]
    ["Mercy" [] "The secret? It’s re-runs of Sex in the City."]
    ["Symmetra" [] "Are you following me? I said I was leaving."]
    [nil [] "You run. Fast. Thankfully, you lose her, despite her Guardian Angeling to you a few more times."]
    :-> [:spawn :choice]]
