  ...
  {[:spawn :dva 0]
   ...
   [:miranda/dialogue
    ...
    ["Lucio" [[:lucio :_prayExplain (scoot -4)] [:dva :_switchNeutral (scoot -4)] [:symmetra :_neutral (scoot 4)]]
     "Everything is a matter of language. My language shapes my reality. No one speaks exactly the same language because our definitions differ. Every person you meet speaks a strange accent."]
   ...
   [:miranda/dialogue
    ...
    ["D.Va" [[:lucio :_neutral (scoot -4)] [:symmetra :_neutral (scoot 4)] [:dva :_switchPointUp (scoot -4)]]
     "What if ART is the joke all along? Hum? Think on that. And if you, by any chance, are looking for a place to do that thinking, Lucio and I are trying to raise enough internet fun bucks from this match to rent out the arcade. J-Bomb’s coming too. Come hang out!"]
    ["Lucio" [[:lucio :_smile (scoot -4)] [:dva :_switchNeutral (scoot -4)] [:symmetra :_neutral (scoot 4)]]
   ...
   (concat
    [:miranda/dialogue
     ["Symmetra" [[:lucio :_neutral (scoot -4)] [:dva :_switchSmile (scoot -4)] [:symmetra :_sadSmile (scoot 4)]]
