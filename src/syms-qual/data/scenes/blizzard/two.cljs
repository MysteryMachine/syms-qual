   ...
   :-> [:party :sombra 3]]
    ...
    [:party :pharah 1]
     [:miranda/dialogue
      ...
      "So! I got you a present. Anyway, um, here."]
      :-> [:party :pharah 3]]
    ...
    [:party :pharah 2]
     [:miranda/dialogue
      ...
      ["Pharah" [[:pharah :_embarassed (scoot -10)] [:symmetra :_smile (scoot 5)]]
      "Maybe. Actually I think Reinhardt probably got his power armor stuck in one of the turnstiles and they need help dislodging him. I should go."]
      ["Symmetra" [[:pharah :_embarassedBack (scoot -10 -80 1.5)] [:symmetra :_helloWarm (scoot 5 0 1.5)]]
      "Good luck!"]
    :-> [:party :genji 0]]
    ...
    [:party :genji 0]
     [:miranda/dialogue
      ...
      ["Symmetra" [[:symmetra :_awkwardTalk (scoot -25)]]
       ...
       ["Symmetra" [[:genji :_neutral (scoot 25 -80 1.5)] [:mccree :_neutral (scoot -8 -80 1.5)] [:hanzo :_phoneTexting (scoot -16 -80 1.5)] [:symmetra :_embarassed (scoot 6 3 1.5)]]
       "I will heed your advice."]
       ["D.Va" [[:zenyatta :_neutral (scoot -80 5 1.5)] [:dva :_fingerGuns (scoot -80 -35 1.5)] [:symmetra :_embarassed (scoot 3)]]
